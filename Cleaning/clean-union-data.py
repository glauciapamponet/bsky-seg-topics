...
file = "part-00000-tid-5322256841719065438-96f70029-7917-49a2-8a4d-f480e8c3d045-606-1-c000.csv"

dbutils.fs.cp(path, f"file:/tmp/{file}")

# %%
s3_client = boto3.client('s3', aws_access_key_id=ACCESS_KEY, aws_secret_access_key=SECRET_KEY)
s3_client.upload_file(f"/tmp/{file}", "S3-name", f"raw/{file}")
